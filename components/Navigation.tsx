      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="hidden sm:inline font-bold text-lg">DevFlow</span>
          </Link>
        ...
        {isOpen && (
          <div className="md:hidden pb-4 border-t border-border">
            <Link href="/blogs" className="block py-2 text-foreground hover:text-primary transition-colors">
              Explore
            </Link>
            {session?.user && (
              <>
                ...
                <Link href="/profile" className="block py-2 text-foreground hover:text-primary transition-colors">
                  Profile
                </Link>
              </>
            )}
